...
df_clean <- df_clean %>%
  rename(
    ...
    patents_nonresidents = IP.PAT.NRES,
    # poverty
  ...
  mutate(patents_total = patents_residents + patents_nonresidents) 
```
...
desc <- c(
  ...
  patents_residents = "Patent applications, residents",
  patents_nonresidents = "Patent applications, nonresidents",
  patents_total = "Patent applications, total",
  # poverty
  ...
  # debt
  interest_payments = "Interest payments (% of expense)",
  # misc
