...
desc <- c(
  ...
  year = "Year",
  total_hours_worked = "Total annual hours worked",
  labor_productivity_person_growth = "Growth in labor productivity per person employed (in %)",
  labor_productivity_hour_growth = "Growth in labor productivity per hour worked (in %)",
  total_factor_productivity_growth = "Total factor productivity growth (in %)"
)
