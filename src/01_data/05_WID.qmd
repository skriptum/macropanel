...
desc <- c(
  ...
  year = "Year",
  gini = "Gini coefficient of disposable income",
  income_share_b50 = "Income share of bottom 50%",
  income_share_t10 = "Income share of top 10%",
  share_ratio = "Ratio of income share of top 10% to bottom 50%"
)

common::labels(df_inequal) <- desc
```
